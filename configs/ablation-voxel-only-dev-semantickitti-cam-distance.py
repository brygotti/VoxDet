data_root = '/transfer/semantickittii/dataset/'
ann_file = '/transfer/semantickittii/labels/'
stereo_depth_root = '/transfer/semantickittii/dataset/depth/'
camera_used = ['left']
...
load_from='/home/montlahu/VoxDet/ckpt/preatrain_depth_model.ckpt'